...
- **[Início Rápido da API](../api/quickstart.md)**: Exemplos práticos de uso da API.
- **[Guia de Configuração](environment-vars.md)**: Guia para variáveis de ambiente.
- **[Guia de Implantação](../../operations/deployment.md)**: Implantação em produção.
- **[Changelog](../../../packages/backend/CHANGELOG.md)**: Histórico de versões.
